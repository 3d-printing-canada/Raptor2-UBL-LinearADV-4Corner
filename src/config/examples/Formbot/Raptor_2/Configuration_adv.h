...
//#define CASE_LIGHT_PIN 8                    // Now set in appropriate pins file
  ...
  #ifdef ROXYs_TRex
    #define CASE_LIGHT_DEFAULT_BRIGHTNESS  15 // Set default power-up brightness (0-255, requires PWM pin)
  #else
...
//#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS (438.5)          // set maximum to the distance between toolheads when both heads are homed
  ...
  #define TOOLCHANGE_UNPARK_ZLIFT 1.0      // the distance to raise Z axis when unparking an extruder
...
#define LCD_TIMEOUT_TO_STATUS 7500
